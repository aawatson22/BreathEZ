...
public class Evaluate {
	 ...
	 * @param values the test data set in .csv format
	 * @throws Exception
	 */
	public static String evalClassifier(RandomForest rf, String[] values) throws Exception {

		//BufferedReader reader = new BufferedReader(new FileReader(testData));

		// Read and store the names of the features
		//String headerLine = reader.readLine();
		String[] featureNames = {"max", "rmin", "lmin", "rslope", "lslope"};
